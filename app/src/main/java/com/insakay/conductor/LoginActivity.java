...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, AdapterView.OnItemSelectedListener {
    ...
    private String conductorID, opUID, opID, conductorKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBusView = (EditText) findViewById(R.id.busID);
        ...
        mLoginFormView = findViewById(R.id.phone_login_form);
...
//                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 5000, 0, locationListener);
    ...
    private void addOperatorsOnList() {

        String uid = "";
        operators = new HashMap<String, String>();
        list = new ArrayList<String>();
        spinnerView =(Spinner) findViewById(R.id.spinner_operators);
            ...
            .addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        operators.put(name, uid);
                        list.add(name);
                    }
                    dataAdapter.notifyDataSetChanged();
//                    Set a = operators.entrySet();
//                    for(Object b : a) {
//                        Map.Entry c = (Map.Entry)b;
...
//                    }
    ...
    private void attemptLogin() {
        ...
        if (spinnerView.getSelectedItem().toString().equals("Select Operator")) {
            spinnerView.setPrompt("Please Select An Operator");
            spinnerView.requestFocus();
        } else {
            // Show a progress spinner, and kick off a background task to
            // perform the user login attempt.
            showProgress(true);
            found = false; correct = false; busFound = false; alreadyLogged = false;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String opName = spinnerView.getSelectedItem().toString();
            opUID = operators.get(opName);
...
//                            opID = dataSnapshot.child("operatorID").getValue().toString();
//                        }
//
//                        @Override
...
//                    });
            ...
            FirebaseDatabase.getInstance().getReference("users/" + opUID + "/buses")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    String busID = mBusView.getText().toString();
                    String fBase;
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()) {
